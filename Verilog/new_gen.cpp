...
int main()
{
  ...
  std::string directory = "./sim/INPUT_VECTORS/";
  
  ofstream MyFile("NoC_TB_test.v");
  DIR *dp;
  int num_of_files = 0;
  struct dirent *ep;
  dp = opendir("./sim/INPUT_VECTORS");
  ...
  string delays[] = {"delay0.dat", "delay1.dat", "delay2.dat", "delay3.dat", "delay4.dat", "delay5.dat", "delay6.dat", "delay7.dat", "delay8.dat"};
  // Write to the file
