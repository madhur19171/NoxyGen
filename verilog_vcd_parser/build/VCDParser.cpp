...
#line 848 "./build/VCDParser.cpp"
    break;

  case 15:
#line 138 "./src/VCDParser.ypp"
                               {
...
#line 859 "./build/VCDParser.cpp"
    break;

  case 16:
#line 145 "./src/VCDParser.ypp"
               {
...
#line 877 "./build/VCDParser.cpp"
    break;

  case 17:
#line 158 "./src/VCDParser.ypp"
                                            {
    driver.fh -> version = yystack_[1].value.as < std::string > ();
}
#line 885 "./build/VCDParser.cpp"
    break;

  case 25:
#line 174 "./src/VCDParser.ypp"
    { yylhs.value.as < VCDScopeType > () = yystack_[0].value.as < VCDScopeType > (); }
#line 891 "./build/VCDParser.cpp"
    break;

  case 26:
#line 175 "./src/VCDParser.ypp"
    { yylhs.value.as < VCDScopeType > () = yystack_[0].value.as < VCDScopeType > (); }
#line 897 "./build/VCDParser.cpp"
    break;

  case 27:
#line 176 "./src/VCDParser.ypp"
    { yylhs.value.as < VCDScopeType > () = yystack_[0].value.as < VCDScopeType > (); }
#line 903 "./build/VCDParser.cpp"
    break;

  case 28:
#line 177 "./src/VCDParser.ypp"
    { yylhs.value.as < VCDScopeType > () = yystack_[0].value.as < VCDScopeType > (); }
#line 909 "./build/VCDParser.cpp"
    break;

  case 29:
#line 178 "./src/VCDParser.ypp"
    { yylhs.value.as < VCDScopeType > () = yystack_[0].value.as < VCDScopeType > (); }
#line 915 "./build/VCDParser.cpp"
    break;
...
#line 927 "./build/VCDParser.cpp"
    break;

  case 35:
#line 197 "./src/VCDParser.ypp"
                                               {
...
#line 945 "./build/VCDParser.cpp"
    break;

  case 36:
#line 213 "./src/VCDParser.ypp"
                                   {
...
#line 987 "./build/VCDParser.cpp"
    break;

  case 37:
#line 250 "./src/VCDParser.ypp"
                                   {
...
#line 1013 "./build/VCDParser.cpp"
    break;

  case 38:
#line 273 "./src/VCDParser.ypp"
                   {
...
#line 1035 "./build/VCDParser.cpp"
    break;

  case 40:
#line 286 "./src/VCDParser.ypp"
                 {
    yylhs.value.as < VCDSignal* > ()  = new VCDSignal();
...
#line 1046 "./build/VCDParser.cpp"
    break;

  case 41:
#line 294 "./src/VCDParser.ypp"
            {
    yylhs.value.as < std::string > () = std::string();
}
#line 1054 "./build/VCDParser.cpp"
    break;

  case 42:
#line 297 "./src/VCDParser.ypp"
                     {
    yylhs.value.as < std::string > () = std::string(yystack_[0].value.as < std::string > ());
}
#line 1062 "./build/VCDParser.cpp"
    break;

  case 43:
#line 302 "./src/VCDParser.ypp"
          {
    yylhs.value.as < std::string > () = std::string();
}
#line 1070 "./build/VCDParser.cpp"
    break;
...
#line 1078 "./build/VCDParser.cpp"
  ...
  case 45:
#line 311 "./src/VCDParser.ypp"
          {
    yylhs.value.as < std::string > () = std::string();
}
#line 1086 "./build/VCDParser.cpp"
    break;

  case 46:
#line 314 "./src/VCDParser.ypp"
                  {
    yylhs.value.as < std::string > () = std::string(yystack_[0].value.as < std::string > ());
}
#line 1094 "./build/VCDParser.cpp"
    break;
...
#undef YYCASE_
  ...
  parser::yyrline_[] =
  {
     ...
     111,   114,   117,   118,   134,   138,   144,   158,   164,   165,
     166,   167,   168,   169,   170,   174,   175,   176,   177,   178,
     181,   190,   191,   194,   195,   197,   213,   250,   273,   279,
     285,   294,   297,   302,   305,   311,   314
  };
...
#line 1547 "./build/VCDParser.cpp"

#line 318 "./src/VCDParser.ypp"
